  ...
  return (
    <>
      ...
      <div className="water_div">
        <CustomFieldset fieldsetClass="water_fieldset" legendClass="water_legend"><Input id={1} type="number" >Попередні, м:<sup>3</sup></Input>
        <Input id={2} type="number" >Поточні, м<sup>3</sup></Input>
        <Input id={3} type="number" >Різниця, м<sup>3</sup>:</Input>
        <Input id={4} type="number" readOnly={true}>До сплати, грн:</Input></CustomFieldset>
